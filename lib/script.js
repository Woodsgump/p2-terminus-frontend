...
function main() {
    ...
    if (loggedInCustomer) {
        ...
        v.btnLogInContainer.style.display = 'none';
        v.btnSignupContainer.style.display = 'none';
        v.btnLogOutContainer.style.display = 'inline-block';

    } else {

        v.btnLogInContainer.style.display = 'inline-block';
        v.btnSignupContainer.style.display = 'none';
        v.btnLogOutContainer.style.display = 'none';
...
function loginFetch() {
    ...
    if (loggedInCustomer) {
        ...
        v.btnLogInContainer.style.display = 'none';
        v.btnSignupContainer.style.display = 'inline-block';
        v.btnLogOutContainer.style.display = 'none';
