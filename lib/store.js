...
function showAllProducts(data) {
    ...
    if (document.getElementById("storeBtnContainer")) {
        document.getElementById("storeBtnContainer").innerHTML = `<div onclick="main();" class="xButton" style="display: inline-block;text-align: center;"><i style="margin-right:0.7em;" class="fa-duotone fa-house"></i> Home</div>
