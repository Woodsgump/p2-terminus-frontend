...
function showAllProducts(data) {
    ...
    let btns = `<div id="categoryBtn" class="xButton right" style="display: inline-block;text-align: center;"><i style="margin-right:0.7em;" class="fa-duotone fa-list"></i> Categories</div>
    <div id="featuredBtn" class="xButton" style="display: inline-block;text-align: center;"><i style="margin-right:0.7em;" class="fa-duotone fa-stars"></i> Featured</div>`;
