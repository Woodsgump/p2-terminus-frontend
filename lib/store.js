...
function showAllProducts(data) {
    ...
    let btns = `<div id="categoryBtn" class="xButton" style="display: inline-block;"><i style="margin-right:0.7em;" class="fa-duotone fa-list"></i> Categories</div>
    <div id="featuredBtn" class="xButton feat" style="display: inline-block;margin-right:1em;"><i style="margin-right:0.7em;" class="fa-duotone fa-stars"></i> Featured</div>`;
