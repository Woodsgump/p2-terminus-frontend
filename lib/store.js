...
let _cB = document.getElementById("categoryBtn");
let _sN = document.getElementById("storeNav");

//Event Listeners
if (!!_sN) {
    _sN.addEventListener('click', getStore);
}
if (!!_cB) {
    _cB.addEventListener('click', getCategory);
}
...
function showProduct(data) {
    ...
    divs += `
        <div id="backStoreBtn" class="xButton" style="display: inline-block;"><i style="margin-right:0.7em;" class="fa-duotone fa-angles-left"></i> Back to store</div>
...
function showAllProducts(data) {
    ...
    let btns = `<div id="featuredBtn" class="xButton" style="display: inline-block;margin-right:1em;"><i style="margin-right:0.7em;" class="fa-duotone fa-stars"></i> Featured</div>
    <div id="categoryBtn" class="xButton" style="display: inline-block;"><i style="margin-right:0.7em;" class="fa-duotone fa-list"></i> Categories</div>`;
