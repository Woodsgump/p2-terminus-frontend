...
function showProduct(data) {
    ...
    <div onclick="getStore();" id="storeBtn" class="xButton" style="display: inline-block;min-width: 113px;text-align: center;"><i style="margin-right:0.5em;" class="fa-duotone fa-shop"></i></i> Store</div>
        ...
        <div id="cartBtn" onclick="update_cart(${data.id}, 1, '${data.title}')" style="margin-top:1em;width: fit-content;" class="xButton" href="#">Add to Cart <i style="margin-left:0.7em;font-size:smaller;" class="fa-duotone fa-cart-shopping"></i></div>
        </div>
        </div>
        </div>
        </div>
