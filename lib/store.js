...
function showProduct(data) {
    ...
    divs += `
    <div onclick="main();" id="backBtn" class="xButton" style="display: inline-block;min-width: 113px;text-align: center;"><i style="margin-right:0.7em;" class="fa-duotone fa-house"></i> Home</div>
    <div onclick="getStore();" id="storeBtn" class="xButton" style="display: inline-block;min-width: 113px;text-align: center;"><i style="margin-right:0.7em;" class="fa-duotone fa-shop"></i></i> Store</div>
