...
function showProduct(data) {
    ...
    divs += `
        ...
        <div class="column">
        <div class="productImage" style="margin-top:1em;width:400px !important;height:400px !important;background-image: url('${data.image}');"></div>
        </div>
        <div class="column">
        ${data.description}
        </div>
        ...
        <div style="float:right;margin-top: -9em;margin-right: 2em;font-size: larger;">
        <h3 style="margin-bottom:8px;">$${data.price}</h3>

        ${data.rating.rate} (${data.rating.count} ratings)
        <div style="margin-top:1em;" class="xButton" href="#">Add to Cart <i style="margin-left:0.7em;font-size:smaller;" class="fa-duotone fa-cart-shopping"></i></div>
        </div>
