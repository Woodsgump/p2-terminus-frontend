...
async function getAllProducts(url) {
    ...
    document.getElementById('storeContainer').innerHTML = `<div id="storeBtnContainer" style="width:100%;display:none;">
    <div onclick="main();" class="xButton" style="display: inline-block;text-align: center;"><i style="margin-right:0.7em;" class="fa-duotone fa-house"></i> Home</div>
...
function showProduct(data) {
    ...
    divs += `
        <div id="backStoreBtn" onclick="getStore();" class="xButton" style="display: inline-block;min-width: 137px;text-align: center;"><i style="margin-right:0.7em;" class="fa-duotone fa-angles-left"></i> Back to store</div>
...
function showAllProducts(data) {
    ...
    document.getElementById('contentContainer').style.display = 'none';
    document.getElementById('storeContainer').style.display = 'inline-block';
    storeBtns.style.display = 'inline-block;'
