...
function showAllProducts(data) {
    ...
    let btns = `<div id="categoryBtn right" class="xButton" style="display: inline-block;min-width: 137px;text-align: center;"><i style="margin-right:0.7em;" class="fa-duotone fa-list"></i> Categories</div>
    <div id="featuredBtn" class="xButton" style="display: inline-block;min-width: 137px;text-align: center;"><i style="margin-right:0.7em;" class="fa-duotone fa-stars"></i> Featured</div>`;
